          ...
          >
            <div className="relative mb-6">
              <img
                src={coding}
                alt="coding service"
                className="w-full h-48 object-cover rounded-xl border-b-8 border-yellow-500"
              />
            ...
            <h3 className="text-indigo-700 font-semibold text-lg text-center">Affordable techie team training</h3>
          </div>
        ))}
      </div>
    </div>
